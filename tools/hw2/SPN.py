...
# if __name__ == "main":
# a = "0010_0110_1011_0111"
# b = "0011_1010_1001_0100_1101_0110_0011_1111"
# a_bits = [int(bit) for bit in a.replace("_", "")]
# b_bits = [int(bit) for bit in b.replace("_", "")]
...
for r in range(1, Nr):
    u = xor(w, get_Kr(r, K))
    v = do_substitute(u)  # (u, l, m)# 哎呀，都指定是4了，没什么好传的
    w = do_permutation(v)
u = xor(w, get_Kr(Nr, K))
v = do_substitute(u)
